...
const validations = [
  ...
  body("skuItem").not().isEmpty().withMessage("Debe agregar un identificador"),
  body("itemPrice").not().isEmpty().withMessage("Debe agregar un Precio"),
  body("itemStock").not().isEmpty().withMessage("Debe agregar existencias"),
